    ...
    return W.matches = function(a, b) {
        ...
        attr: function(a, b) {
            var c;
            return "string" == typeof a && b === v ? this.length && 1 === this[0].nodeType?!(c = this[0].getAttribute(a)) && a in this[0] ? this[0][a] : c : v : this.each(function(c) {
                if (1 === this.nodeType)
                    if (e(a))
                        for (w in a)
                            r(this, w, a[w]);
        ...
        x.fn[b] = function() {
            ...
            return 1 > f.length ? this : this.each(function(a, b) {
                ...
                var h = E.documentElement.contains(e);
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function(a) {
    ...
    a.active = 0, a.ajaxJSONP = function(b, c) {
        ...
        d(c), c.crossDomain || (c.crossDomain = /^([\w-]+:)?\/\/([^\/]+)/.test(c.url) && RegExp.$2 != window.location.host), c.url || (c.url = "" + window.location), m(c), c.cache===!1 && (c.url = l(c.url, "_=" + Date.now()));
        ...
        if (v.setRequestHeader = t, v.onreadystatechange = function() {
            if (4 == v.readyState) {
                ...
                var b, d=!1;
                if (v.status >= 200 && 300 > v.status || 304 == v.status || 0 == v.status && "file:" == u) {
    ...
    a.when = function(d) {
        ...
        if (i > 1)
            for (e = Array(i), f = Array(i), g = Array(i); i > j; ++j)
